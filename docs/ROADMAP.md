...
- [ ] Pull latest llama.cpp master
- [ ] Download 2-bit Qwen 3.7 28b GGUF model

## Phase 2: Rust Bindings & Inference
- [ ] Verify `cargo test` with latest bindings
- [ ] Add benchmarking for 2-bit Qwen inference performance
